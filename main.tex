...
\institute{1: Ocean Biology Processing Group - NASA Goddard Space Flight Center\\
           2: Science Applications International Corporation } % Institution(s)
...
\begin{itemize}
\item Quantify uncertainty due to atmospheric correction.
\item Generate remote sensing reflectance uncertainty product.
\item Characterize uncertainty with respect to potential drivers
\end{itemize}
...
\begin{itemize}
\item Ocean color missions are subject to pre-specified uncertainty requirements.
\item Requirements are borne out of guesswork
...
\item MC simulations computationally costly - requires many runs;
	\begin{itemize}
