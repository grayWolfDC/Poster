...
\setlength{\paperheight}{38in} % A0 height: 33.1in
...
\begin{itemize}
\item Implement self-contained sensor-dependent noise model.
...
\item Typical uncertainty estimation done using potentially problematic comparisons with e.g.;
	\begin{itemize}
	\item in-situ data \cite{BW:2006,Tle:2000}
	\item other ocean color mission\cite{Hu:2013}
\end{itemize}	 
\end{itemize}
\end{block}
...
\begin{block}{Methods}
\begin{itemize}
\item Quantify noise propagation across bands by introducing perturbation at Lt
...
\includegraphics[width=1.0\linewidth]{Propagation.png}
\\{Figure caption}
\end{figure}
...
\includegraphics[width=0.8\linewidth]{global412.png}
...
\small{\rmfamily{Special thanks to \textit{Don Shea} and \textit{Sean Bailey} for assistance with l2gen integration of the MC code, and to \textit{Tommy Owens} for running large scale MC simulations on the OBPG production system.}} \\
