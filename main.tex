...
\item Typical uncertainty estimation uses problematic comparison with in-situ data;
	\begin{itemize}
	\item in-situ data sampling is potentially biased to easily accessible areas,
	\item difficult to separate noise from in-situ and satellite measurements
	\item differences in sampling scale also confounding.
\end{itemize}	 
\item
\item 
\end{itemize}
...
\bibliography{./sample.bib}\vspace{0.75in}}
