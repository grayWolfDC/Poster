...
\includegraphics[width=1.0\linewidth]{rrsPercUnc443.png}
\end{figure}

\begin{figure}
\centering
\textbf{Rrs(555) uncertainty}\par\medskip
\includegraphics[width=1.0\linewidth]{rrsPercUnc490.png}
\end{figure}

\begin{figure}
\centering
\textbf{Rrs(555) uncertainty}\par\medskip
\includegraphics[width=1.0\linewidth]{rrsPercUnc510.png}
\end{figure}
